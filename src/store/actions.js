...
const http = {
    get: function (url, requestJson) {
        return new Promise((resolve, reject) => {
            ajax.get(url, {params: requestJson}).then(res => {
                resolve(res);
            }).catch(err => {
                reject(err);
            });
    ...
    post: function (url, requestJson) {
        return new Promise((resolve, reject) => {
            ajax.post(url, queryString.stringify(requestJson)).then(res => {
                resolve(res);
            }).catch(err => {
                reject(err);
            });
    ...
    put: function (url, requestJson) {
        return new Promise((resolve, reject) => {
            ajax.put(url, queryString.stringify(requestJson)).then(res => {
                resolve(res);
            }).catch(err => {
                reject(err);
            });
    ...
    delete: function (url, requestJson) {
        return new Promise((resolve, reject) => {
            ajax.delete(url, {params: requestJson}).then(res => {
                resolve(res);
            }).catch(err => {
                reject(err);
            });
