...
<script>
  import headerBar from "mobile/components/public/header.vue"
  import footerBar from "mobile/components/public/footer.vue"
  import auth_email from 'mobile/components/public/auth_email_pop';
