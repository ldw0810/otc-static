    ...
    <div :class="classes">
        ...
        <div :class="[prefixCls + '-content']" :style="contentStyles">
            ...
            <transition name="fade">
                <div :class="[prefixCls + '-error-tip']" v-if="validateState === 'error' && showError && showMessage && form.showMessage">{{ validateMessage }}</div>
            </transition>
        </div>
    </div>
</template>
            ...
            classes () {
                return [
                    `${prefixCls}`,
                    {
                        ...
                        [`${prefixCls}-error`]: this.validateState === 'error' && this.showError,
