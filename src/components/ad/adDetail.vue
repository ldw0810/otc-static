        ...
        <Modal v-model="confirmFlag.placeOrder" class-name="m-ivu-modal"
            ...
            <div class="detail-model">
                ...
                <div class="detail-model-warn" v-else>
                    {{adType == 0 ? $t("order.order_confirm_complete_buy_warn").format(form.moneyAmount, $t("public['" + ad.target_currency + "']"), form.number, $t("public['" + ad.currency + "']")) :
                    $t("order.order_confirm_complete_sell_warn").format(form.number, $t("public['" + ad.currency + "']"), form.moneyAmount, $t("public['" + ad.target_currency + "']"))}}
                </div>
        ...
        <Modal width = '480' v-model="confirmFlag.complete" class-name="m-ivu-modal" :mask-closable="true" :closable="false">
            ...
            <div class="detail-model">
                ...
                <div class='detail-model-content' style='width:292px;margin-bottom:92px' v-if="ad.id">
                    <span v-if="adType == 1" v-html='$t("order.order_complete_info").format(form.moneyAmount, $t("public[\"" + ad.target_currency + "\"]"))'></span>
                    <span v-else v-html='$t("order.order_complete_info").format(form.number, $t("public[\"" + ad.currency + "\"]"))'></span>
