    ...
    <div class="g-container">
        <div class='g-shadow ad'>
            <div class='ad-header'>
                ...
                <!-- 备注 -->
                <div class="credit-low-tip" v-if="!balanceFlag && +form.adType !== 1">
            ...
            <Form class="form" ref="form" :model="form" :rules="rules">
                <FormItem prop="adType" class="form-item" v-if="currency !== 'ck'">
                    ...
                    <div class='form-item-radio-group'>
                        <RadioGroup v-model="form.adType">
                ...
                <FormItem prop="payment" class="form-item" v-if="+form.adType === 0 && currency === 'dai'">
                    <header class='form-item-header'>
                    ...
                    <Row>
                        <i-col span='10'>
                            <Select class="input paymentInput" v-model="form.payment">
                ...
                <!--广告类型-->
                <FormItem prop="collection" class="form-item" v-if="+form.adType === 1 && currency === 'dai'">
                    <header class='form-item-header'>
                    ...
                    <Row>
                        <i-col span='10'>
                            <Select class="input paymentInput" v-model="form.collection" v-if="collection_default">
                            ...
                            <Select class="input paymentInput" v-model="form.collection" v-else>
                                <Option v-for="item in paymentList" :value="item" :key="item">
                                    {{$t("public['" + item + "']")}}
                                </Option>
                            </Select>
                ...
                <FormItem prop="money" class="form-item" v-if="currency === 'dai'">
                    ...
                    <Row>
                        <i-col span='10'>
                            <Select class="input" v-model="form.money">
                    ...
                    <Row>
                        <i-col span='10'>
                            <div class="premiumInput">
                                <i-input class="input" v-model="form.premium" type="text"
                ...
                <!--价格-->
                <FormItem prop="buyPrice" class="form-item" v-if="+form.adType === 0 && currency !== 'ck'">
                    <header class='form-item-header'>
                    ...
                    <Row>
                        <i-col span='10'>
                            <i-input class="input" v-model="form.buyPrice" type="text"
                ...
                <FormItem prop="sellPrice" class="form-item" v-if="+form.adType === 1">
                    <header class='form-item-header'>
                    ...
                    <Row>
                        <i-col span='10'>
                            <i-input class="input" v-model="form.sellPrice" type="text"
                ...
                <FormItem prop="maxPrice" class="form-item" v-if="+form.adType === 0 && currency !== 'ck'">
                    <header class='form-item-header'>
                    ...
                    <Row>
                        <i-col span='10'>
                            <i-input class="input" v-model="form.maxPrice" type="text"
                ...
                <FormItem prop="minPrice" class="form-item" v-if="+form.adType === 1 && currency !== 'ck'">
                    <header class='form-item-header'>
                    ...
                    <Row>
                        <i-col span='10'>
                            <i-input class="input" v-model="form.minPrice" type="text"
                ...
                <FormItem prop="floor" class="form-item" v-if="currency !== 'ck'">
                    ...
                    <Row>
                        <i-col span='10'>
                            <i-input class="input" v-model="form.floor" type="text" @on-change="changeFloor"
                ...
                <FormItem prop="ceiling" class="form-item" v-if="currency !== 'ck'">
                    ...
                    <Row>
                        <i-col span='10'>
                            <i-input class="input" v-model="form.ceiling" type="text" @on-change="changeCeiling"
                                     :placeholder="$t('ad.ad_ceiling_required')">
                                <span slot="append">{{moneyText}}</span>
                            </i-input>
                        </i-col>
                        <i-col span='3' offset="1" v-if="+form.adType === 1">
                ...
                <FormItem prop="remark" class="form-item">
                    ...
                    <Row>
                        <i-col span='10'>
                            <i-input class="input" v-model="form.remark" :placeholder="$t('ad.ad_remark_tip')"
        ...
        methods: {
            ...
            changePremium() {
                if (+this.form.adType === 0) {
                    ...
                    this.$nextTick(() => {
                        this.form.sellPrice = this.tradePrice * (1 + (+this.form.premium / 100));
                    });
                }
            },
            changePrice() {
                if (+this.form.adType === 0) {
                    this.$nextTick(() => {
                        this.form.premium = (((+this.form.buyPrice / this.tradePrice) - 1) * 100).toFixed(3);
                    });
                } else if (+this.form.adType === 1) {
                    this.$nextTick(() => {
                        this.form.premium = (((+this.form.sellPrice / this.tradePrice) - 1) * 100).toFixed(3);
                    });
                }
            },
            changeFloor() {
                let tempBalance = +this.balanceObj[this.currency] * this.tradePrice * (1 - +config.poundage);
                if (this.currency === `dai` && +this.form.adType !== 1) {
            ...
            sellAll() {
                this.$nextTick(() => {
                    this.form.ceiling = this.balanceObj[this.currency] * this.tradePrice * (1 - +config.poundage);
                });
            },
            submit() {
                        ...
                        if (valid) {
                            if (this.isUpdate) {
                                ...
                                const requestData = {
                                    ...
                                    min: this.form.floor,
                                    price: +this.form.adType === 0 ? this.form.maxPrice : this.form.minPrice,
                                    margin: this.form.premium,
                                    pay_kind: +this.form.adType === 0 ? this.form.payment : this.form.collection,
                                    pay_default: (this.collection_default && (this.collection_default.id === this.form.collection)) ? 1 : 0,
                                ...
                                const requestData = {
                                    op_type: this.opList[this.form.adType],
                                    currency: this.currency,
            ...
            init() {
                ...
                if (this.isUpdate && this.adId) {
                    ...
                    this.$goRouter(this.$route.fullPath.replace(this.currency, this.currencyList[0]));
                } else {
