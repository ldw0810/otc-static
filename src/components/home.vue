<template>
    <div class="home">
        <div class="carousel">
            <Carousel class='m-ivu-carousel' autoplay :autoplay-speed="carousel.speed" v-model="carousel.value" loop :radius-dot = 'true'>
...
export default {
  ...
  methods: {
    getAds() {
      this.$store
        .dispatch("ajax_ads_main")
        .then(res => {
          if (res.data && res.data.error == 0) {
            this.ads = res.data.buy_ads.concat(res.data.sell_ads);
          } else {
