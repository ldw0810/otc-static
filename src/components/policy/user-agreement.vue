...
您承诺遵守下列本网站服务规则：</p>
	...
	<p>4.2.2 您应当遵守法律法规并妥善使用和保管其本网站账号及登陆密码、资金密码、和其绑定的手机号码、以及手机接收的手机验证码的安全。您对使用其本网站账号和登陆密码、手机验证码进行的任何操作和后果承担全部责任。当您发现本网站账号、登陆密码、验证码被未经其授权的第三方使用，或存在其他账号安全问题时，应立即有效通知本网站，要求本网站暂停本网站账号的服务。本网站有权在合理时间内对您的该等请求采取行动，但本网站对在采取行动前已经产生的后果（包括但不限于您的任何损失）不承担任何责任。您在未经本网站同意的情况下不得将本网站账号以赠与、借用、租用、转让或其他方式处分给他人。</p>
...
language["zh-HK"] = `<h1 class='title'>用戶協議</h1><p>https://www.otcmaker.com（以下稱“本網站”或“網站”），是壹個專門供用戶進行數字資產交易和提供相關服務（以下稱“該服務”或“服務”）的平臺。為了本協議表述之方便，該網站在本協議中使用“我們”或其他第壹人稱稱呼。只要登陸該網站的自然人或其他主體均為本網站的用戶，本協議表述之便利，以下使用“您”或其他第二人稱。為了本協議表述之便利，我們和您在本協議中合稱為“雙方”，我們或您單稱為“壹方”。</p>
	...
	<p>1.4 您成為本網站的會員後，您將獲得壹個會員帳號及相應的密碼，該會員帳號和密碼由會員負責保管；會員應當對以其您帳號進行的所有活動和事件負法律責任。</p>
	<p>1.5 只有成為本網站的會員才可使用本網站提供的數字資產交易平臺進行交易及享受其他本網站規定的只有會員才可獲得的服務；會員外的其他您只有登陸網站、瀏覽網站及其他本網站規定的可獲得的服務。</p>
...
您承諾遵守下列本網站服務規則：</p>
	...
	<p>4.2.2 您應當遵守法律法規並妥善使用和保管其本網站賬號及登陸密碼、資金密碼、和其綁定的手機號碼、以及手機接收的手機驗證碼的安全。您對使用其本網站賬號和登陸密碼、手機驗證碼進行的任何操作和後果承擔全部責任。當您發現本網站賬號、登陸密碼、驗證碼被未經其授權的第三方使用，或存在其他賬號安全問題時，應立即有效通知本網站，要求本網站暫停本網站賬號的服務。本網站有權在合理時間內對您的該等請求采取行動，但本網站對在采取行動前已經產生的後果（包括但不限於您的任何損失）不承擔任何責任。您在未經本網站同意的情況下不得將本網站賬號以贈與、借用、租用、轉讓或其他方式處分給他人。</p>
	...
	<p>5.5 本網站保留隨時修改、中止或終止本網站服務的權利，本網站行使修改或中止服務的權利不需事先告知您；本網站終止本網站壹項或多項服務的，終止自本網站在網站上發布終止公告之日生效。</p>
	<p>5.6 本網站應當采取必要的技術手段和管理措施保障本網站的正常運行，並提供必要、可靠的交易環境和交易服務，維護數字資產交易秩序。</p>
	<p>5.7 如您連續壹年未使用本網站會員賬號和密碼登陸本網站，則本網站有權註銷您的本網站賬號。賬號註銷後，本網站有權將相應的會員名開放給其他您註冊使用。</p>
	...
	<p>8.2 您了解並同意，我們不對因下述任壹情況而導致您的任何損害賠償承擔責任：</p>
	...
	<p>8.5 我們對本網站中鏈接的任何第三方網站的任何信息、產品及業務及其他任何形式的不屬於我們的主體的內容等不做任何保證和承諾，您如果使用第三方網站提供的任何服務、信息及產品等均為您個人決定且承擔由此產生的壹切責任。</p>
	<p>8.6 我們對於您使用本網站服務不做任何明示或暗示的保證，包括但不限於本網站提供服務的適用性、沒有錯誤或疏漏、持續性、準確性、可靠性、適用於某壹特定用途。同時，我們也不對本網站提供的服務所涉及的技術及信息的有效性、準確性、正確性、可靠性、質量、穩定、完整和及時性作出任何承諾和保證。是否登陸或使用本網站提供的服務是您個人的決定且自行承擔風險及可能產生的損失。我們對於數字資產的市場、價值及價格等不做任何明示或暗示的保證，您理解並了解數字資產市場是不穩定的，價格和價值隨時會大幅波動或崩盤，交易數字資產是您個人的自由選擇及決定且自行承擔風險及可能產生的損失。</p>
	...
	<p>3.1.2如果您是壹個公司或其他合法實體，我們將收集以下信息以確定您或信托帳戶的最終受益人。</p>
	<p>公司註冊、登記證；公司的章程與備忘錄副本；公司的股權機構和所有權說明的詳細證明材料，證明決定本網站賬戶的開立以及執行的授權委托人的董事會決議；按照要求需要提供的公司董事、大股東及本網站賬戶有權簽字人的身份證明文件；該公司的主要營業地址，如果與公司的郵寄地址不同，提供郵寄地址。如果公司在本地的地址與它的主要營業地址不壹致的，則被視為風險較高的客戶，需要提交額外附加文件。</p>
