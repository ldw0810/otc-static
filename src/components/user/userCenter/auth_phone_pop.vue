<template>
    <div id="popPage">
        <logoDiv></logoDiv>
        <div class="addContent" v-if="!auth_flag">
            ...
            <Form class="form" ref="addForm" @checkValidate='checkValidate_addForm':model="addForm" :rules="addRules">
                ...
                <FormItem prop="pinCode" class="formItem">
                    ...
                    <i-input class="inputPinCode" type="text" v-model="addForm.pinCode" @on-enter="submit" :placeholder="$t('user.pinCode_required')">
                        <span slot="prepend">
                            <img src="../../../static/images/icon/IdentifyingCode-CCCCCC.svg">
                        </span>
                    </i-input>
                    <sendCodeButton  ref="sendButton" @sendCode="sendPinCode"></sendCodeButton>                       
                    </div>
                </FormItem>
            ...
            <Form class="form" ref="delForm" @checkValidate='checkValidate_delForm' :model="delForm" :rules="delRules">
                ...
                <FormItem prop="pinCode" class="formItem">
                    <div class='g-send-group'>
                        ...
                        <sendCodeButton @sendCode="sendPinCode"></sendCodeButton>
                    </div>
                </FormItem>
                <FormItem class="formItem submit">
                    <div class="g-comfirm-group">
                        <i-button class="submitButton" :disabled='!validate.delForm' :loading='submitloading' type="primary" @click="submit">
                            {{$t('public.confirm')}}
                        </i-button>
                        <i-button class="cancelButton" @click="cancel">
                            {{$t('public.cancel')}}
...
<script type="es6">
    ...
    export default {
        ...
        computed: {
            ...
            phone_number(){
                return this.$store.state.userInfo.phone_number;
            },
            country_default(){
                return {
                    value: "CN",
